...
#     operacao = input("Digite uma das operações que deseja realizar entre os número digitados (+, -, *, /): ")
...
#         print(f"Resultado: {resultado}")
#     else:   
#         print("Operador inválido / divisão por zero não permitida")    
# except ValueError as e:
...
lista_num = input("Digite uma lista de números separados por virgula: ")
lista = lista_num.split(",")
lista_num_int = []
try:
    for num in lista:
        lista_num_int.append(int(num.strip()))
    print(lista_num_int)
except ValueError as e:
